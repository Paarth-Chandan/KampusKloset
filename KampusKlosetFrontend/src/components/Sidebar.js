...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      } w-full bg-white fixed top-24 h-full 
    shadow-2x1 md:w-[35vw] xl:max-w-[30vw] transition-all duration-300 z-20px-4 lg:px-[35px]`}
    >
      ...
      <div
        className="flex flex-col gap-y-2 h-[520px] lg:h-[290px] 
